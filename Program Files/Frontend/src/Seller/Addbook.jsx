...
const handleSubmit = async (e) => {
  ...
  return (
    <div> 
        <Vnavbar/>
    <div className="max-w-md mx-auto mt-8 p-4 border rounded shadow-lg" style={{backgroundColor:"grey"}}>
      ...
      <div className="mb-4">
        ...
        <div className="mb-4">
          <label className="block text-white-600">Item Image</label>
          <input
            type="file"
            name="itemImage"
            accept="image/*"
        ...
        <button
          type="submit"
          className="bg-pink-900 hover:bg-pink-500 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
        >
          Submit
        </button>
      </form>
