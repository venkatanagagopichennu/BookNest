...
function Shome() {
  ...
  const colors = ['#2B124C', '#AE4451', '#F39F5A','orange,black'];
  ...
  const data = [
    ...
    { name: 'Items', value: totalItems, fill: 'pink' }, 
    { name: 'Orders', value: totalOrders, fill: 'red' }, 
  ];
  return (
    <div>
        <Snavbar/>
      ...
      <Card body style={{ backgroundColor: "white", width: "80%", marginLeft: "10%", marginTop: "20px", height: "580px" }}>
        <div className="flex justify-around items-center p-4">
         ...
         <Link to="/orders" style={{textDecoration:"none"}}>
          <div className="w-64 h-32 bg-red-500 rounded-lg shadow-md flex flex-col justify-center items-center text-xl font-bold text-white-800 text-center">
       ...
       <BarChart width={400} height={300} data={data} >
          ...
          <Tooltip   />
          <Legend />
          <Bar dataKey="value" fill="white" barSize={50} />
