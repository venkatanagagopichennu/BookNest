  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-pink-100">
      ...
      {/* <div className=" h-5  w-full  bg-indigo-500 transform skew-y-6 origin  "></div> */}
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-grey-500 focus:border-grey-500 sm:text-sm"
              placeholder="Name"
            />
          </div>
          <div>
        ...
        <div className="absolute h-full w-full bg-grey-500 transform -skew-y-6 origin-bottom-right"></div>
